...
| BM-12 | Home-care sponsor or care coordinator | Home-care coordination support, not direct care delivery, for non-urgent continuity tasks only | Home-care coordination fee | care coordinator staffing, scheduling infrastructure, escalation tooling, and referral handoff readiness | local care-provider agreements and clinical-safety obligations | coordination workflow maturity, emergency escalation readiness, and continuity assurance | incomplete handover and unsafe escalation timing | case prioritization pressure, delayed follow-up, unsafe delegation | Controlled-pilot review only if explicitly approved later; otherwise remains deferred as architecture-only | Escalation response quality, closure completeness, and adverse-event trend | PROPOSED | Operations lead + Clinical lead + Legal counsel |
