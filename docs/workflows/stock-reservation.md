...
| Field | Value |
|---|---|
| Document title | Stock reservation state machine |
| Workflow ID | WFL-009 |
...
| Escalation owner role | Pharmacy operations lead |
| Scope label | PILOT |
...
| Related exceptions | EXC-027,EXC-028 |
| Related decisions | REQ-WFL-001 through REQ-WFL-025 |
| Related open questions | OQ-00-75,OQ-00-95,OQ-00-104,OQ-00-120 |
| Related events | EVT-037,EVT-038,EVT-039 |

## Purpose

This workflow controls the authoritative lifecycle of StockReservation in the Pharmacy Fulfilment bounded context. It does not own unrelated orthogonal facts, downstream projections, external partner state, UI-only state, payment-provider state, or browser-local state. Coverage includes: Exact medication, strength, form, quantity; available-stock guard; atomic reservation; expiry; release; consumption; partial fulfilment question; duplicate consume/release; stock correction; out-of-stock; inventory conflict; reconciliation; no double sale.

## Aggregate or Entity Controlled

- Canonical entity: StockReservation.
...
|---|---|---|---|---|---|---|---|---|---|---|
| REQUESTED | Conceptual lifecycle state for Stock reservation. | NONTERMINAL | Pharmacy operations | Pharmacy operations lead | Explicit transition command accepted with valid version. | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT until approved | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| RESERVED | Conceptual lifecycle state for Stock reservation. | NONTERMINAL | Pharmacy operations | Pharmacy operations lead | Explicit transition command accepted with valid version. | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT until approved | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| CONSUMED | Conceptual lifecycle state for Stock reservation. | NONTERMINAL | Pharmacy operations | Pharmacy operations lead | Explicit transition command accepted with valid version. | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT until approved | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| RELEASED | Conceptual lifecycle state for Stock reservation. | TERMINAL-SUCCESS | Historical owner for record retention | Pharmacy operations lead | Explicit transition command accepted with valid version. | Not applicable after terminal entry | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| EXPIRED | Conceptual lifecycle state for Stock reservation. | TERMINAL-CANCELLATION | Historical owner for record retention | Pharmacy operations lead | Explicit transition command accepted with valid version. | Not applicable after terminal entry | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| FAILED | Conceptual lifecycle state for Stock reservation. | TERMINAL-FAILURE | Historical owner for record retention | Pharmacy operations lead | Explicit transition command accepted with valid version. | Not applicable after terminal entry | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| CANCELLED | Conceptual lifecycle state for Stock reservation. | TERMINAL-CANCELLATION | Historical owner for record retention | Pharmacy operations lead | Explicit transition command accepted with valid version. | Not applicable after terminal entry | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
| RECONCILIATION_REQUIRED | Conceptual lifecycle state for Stock reservation. | NONTERMINAL | Pharmacy operations | Pharmacy operations lead | Explicit transition command accepted with valid version. | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT until approved | Authorized transition, terminal closure, or approved Reopen where allowed. | Derived safe label for the current state. | Minimum necessary data; no secrets/raw payment data; provider/location data redacted unless authorized. | PILOT; timeouts and thresholds remain approval-gated. |
...
stateDiagram-v2
  [*] --> REQUESTED
  REQUESTED --> RESERVED : command
  RESERVED --> CONSUMED : command
  CONSUMED --> RELEASED : command
  REQUESTED --> EXPIRED : command
  REQUESTED --> FAILED : command
  REQUESTED --> CANCELLED : command
  REQUESTED --> RECONCILIATION_REQUIRED : command
  RELEASED --> [*]
  EXPIRED --> [*]
  FAILED --> [*]
  CANCELLED --> [*]
...
|---|---|---|---|---|---|---|---|
| REQUESTED | Pharmacy operations lead | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT; no numeric value approved in P00-07 | Minimum necessary reminder only if approved | Escalate to Pharmacy operations lead by approved policy | None unless explicitly approved later | Owner review required; unresolved work remains queued | OQ-00-75,OQ-00-95,OQ-00-104,OQ-00-120 |
| RESERVED | Pharmacy operations lead | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT; no numeric value approved in P00-07 | Minimum necessary reminder only if approved | Escalate to Pharmacy operations lead by approved policy | None unless explicitly approved later | Owner review required; unresolved work remains queued | OQ-00-75,OQ-00-95,OQ-00-104,OQ-00-120 |
| CONSUMED | Pharmacy operations lead | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT; no numeric value approved in P00-07 | Minimum necessary reminder only if approved | Escalate to Pharmacy operations lead by approved policy | None unless explicitly approved later | Owner review required; unresolved work remains queued | OQ-00-75,OQ-00-95,OQ-00-104,OQ-00-120 |
| RECONCILIATION_REQUIRED | Pharmacy operations lead | CONFIGURED-POLICY or NO-AUTOMATIC-TIMEOUT; no numeric value approved in P00-07 | Minimum necessary reminder only if approved | Escalate to Pharmacy operations lead by approved policy | None unless explicitly approved later | Owner review required; unresolved work remains queued | OQ-00-75,OQ-00-95,OQ-00-104,OQ-00-120 |
...
|---|---|---|---|---|---|---|
| Transition command | User/system retry | WFL-009 instance + command + actor + version | Return prior result or explicit conflict | Reject if state cannot accept command | Pharmacy operations lead | Pharmacy operations review queue |
| External callback | Partner adapter | External callback reference + WFL-009 instance | Process once; subsequent duplicates acknowledged | Do not regress state; route contradiction to reconciliation | Pharmacy operations lead | Adapter exception queue |
| Reopen command | Authorized reviewer | Terminal instance + reason + actor | Duplicate returns reopened instance or conflict | Reject if superseded by newer instance | Pharmacy operations lead | Governance review |
...
| External partner callback contradicts authoritative state | OpenReconciliation | Pharmacy operations lead | Reconciliation or exception state | No state regression; downstream projections corrected after review | Required | As approved | Required |
...
- Related workflows are listed in the state-machine index and cross-workflow invariants. Stock reservation consumes or produces states through explicit commands/events only.
...
- One authoritative current state exists for each StockReservation workflow instance.
