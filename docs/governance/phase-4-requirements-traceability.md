...
- API unit tests command: `node node_modules/vitest/vitest.mjs run apps/api/src/granular-consent.test.ts apps/api/src/authorization-policy.test.ts apps/api/src/authorization-policy-handlers.test.ts apps/api/src/runtime-routes.test.ts`
- API unit tests result: `4 passed files, 26 passed tests (0.74s)`
