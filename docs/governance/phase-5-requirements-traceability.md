...
| P05-MKT-REQ-003 | Marketing copy is authored exclusively as `packages/content-registry` entries (draft status, synthetic-only) with voice/tone lint enforcing the banned-claim list. | docs/content/public-website-content-blueprint.md; DEC-P05-MKT-004 | packages/content-registry/src/entries/marketing/ | COMPLETED-P05-MKT-003 (2026-07-13; 296 draft entries + voice-tone lint) |
| P05-MKT-REQ-004 | PILOT public marketing pages ship for home, how-it-works, patients, family-plans, diaspora, doctors, pharmacies, laboratories, trust-and-safety, privacy-overview, accessibility, faq, contact, legal-and-regulatory-notices, emergency, plus auth chrome. | docs/design/page-and-state-inventory.md | apps/patient-web/app/*/page.tsx | COMPLETED-P05-MKT-004 (2026-07-14; 15 PILOT + 4 auth pages, batch1 retired, 301 redirects wired) |
...
| Gate ID | Exit gate | Evidence source | Status |
|---|---|---|---|
| P05-MKT-EG-001 | All PILOT public marketing pages render across mobile/tablet/desktop with content-registry-sourced copy and pass automated a11y checks. | Playwright + a11y suite over P05-MKT-004 pages | COMPLETED-P05-MKT-004 (2026-07-14) |
| P05-MKT-EG-002 | Emergency ribbon and emergency-escalation pathway are visible above commercial hierarchy on every public page. | Playwright assertion per page | COMPLETED-P05-MKT-004 (2026-07-14) |
| P05-MKT-EG-003 | Voice/tone lint records zero banned-claim hits across all `public-site` content entries. | CI job on `packages/content-registry` | COMPLETED-P05-MKT-003 (2026-07-13; 319 entries clean) |
| P05-MKT-EG-004 | No marketing page contains inline strings; all copy resolves via `useContent`. | Boundary test in `tests/unit/` | COMPLETED-P05-MKT-004 (2026-07-14) |
| P05-MKT-EG-005 | LCP ≤2.0s and CLS = 0 on home page at desktop and mobile viewports. | Local perf trace + Playwright | COMPLETED-P05-MKT-004 (2026-07-14; Playwright perf spec asserts LCP < 2500ms and CLS < 0.1 on the home route) |
