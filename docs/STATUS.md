...
- Phase 4: KICKOFF-STARTED, P04-ISS-001 DEFINED WITH EVIDENCE-FIRST ACCEPTANCE CRITERIA.
...
- Next action: execute P04-ISS-001 authorization/consent/guardianship/audit foundation with deterministic policy tests and fail-closed browser evidence.
