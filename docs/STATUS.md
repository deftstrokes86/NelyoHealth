...
- Next action: execute P05-MKT-004 (PILOT marketing pages) — wire the 14 marketing components + gallery-audited illustrations to the 296 P05-MKT-003 draft entries, ship every PILOT page with `generateMetadata` sourcing `marketing-seo.*`, and validate both themes per page. P05-ISS-002 browser-observable low-bandwidth UX extension continues in parallel.
