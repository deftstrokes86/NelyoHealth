 ...
 */
export type TimelineResourceDomainDto = "appointment" | "consultation" | "medication" | "lab" | "clinical-record" | "document" | "message";
...
export declare function createTimelineEntryDto(fields: {
    entryId: string;
    resourceDomain: TimelineResourceDomainDto;
    entryType: string;
    aggregateRef: string;
