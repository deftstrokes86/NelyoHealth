...
export type { DiagnosticResultDraftDto, DiagnosticResultDraftRequestDto } from "./diagnostic-results.js";
...
export type { AuthorizationPermissionDraftDto, AuthorizationPermissionDraftRequestDto } from "./authorization.js";
...
export type { ProviderDisclosureDecisionDraftDto, ProviderDisclosureDecisionDraftRequestDto } from "./provider-disclosure.js";
...
export type { ReferralDraftAdvancedDto, PrescriptionDraftAdvancedDto } from "./referral-prescription.js";
...
export type { RuntimeRouteMetaDto, PaymentTransitionRouteRequestDto, RefundTransitionRouteRequestDto, ProviderDisclosureEligibilityRouteRequestDto } from "./runtime-routes.js";
...
export declare const apiClientPackageBoundary: {
    readonly id: "api-client";
    readonly packageName: "@nelyohealth/api-client";
    readonly kind: "shared-package";
    readonly status: "phase-2-foundation";
    readonly owningIssue: "P02-ISS-006";
    readonly publicApi: "Generated OpenAPI typed client";
    readonly runtimeImplementation: true;
    readonly featureImplementation: false;
};
